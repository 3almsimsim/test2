...
const one_secDOM = document.querySelector('.secondary_one_container');
...
class Products {
  async getProducts() {
    try {
      let result = await fetch("../jsonFolder/secondary_one.json");
...
class UI {
    ...
    products.forEach(product => {
      if(product.section === "secondary_one"){
        result += `

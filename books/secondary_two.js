...
const two_secDOM = document.querySelector('.secondary_two_container');
...
class Products {
  async getProducts() {
    try {
      let result = await fetch("../jsonFolder/secondary_two.json");
...
class UI {
    ...
    products.forEach(product => {
      if(product.section === "secondary_two"){
        result += `
